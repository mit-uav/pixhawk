...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/sam/Desktop/pixhawk/src/mavros-mod/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/sam/Desktop/pixhawk/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /home/sam/Desktop/pixhawk/install)
...
if(NOT "/home/sam/Desktop/pixhawk/src/mavros-mod/libmavconn/include;/usr/include;/opt/ros/indigo/include" STREQUAL "")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/sam/Desktop/pixhawk/src/mavros-mod/libmavconn/include;/usr/include;/opt/ros/indigo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sam/Desktop/pixhawk/src/mavros-mod/libmavconn/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
